...
| A6 | Checked `remaining()`, `open_channel(nonce)` | [05-channel.md](05-channel.md) | Per-channel asset escrow; snapshots; wrong/reused nonce rejects | `Open`, increment next nonce, `counter=0` |
...
| A7 | Request/cancel transition | [05-channel.md](05-channel.md) | Closing freezes delivery; AdoptTerms pre-funds pending escrow; cancel refunds it; same-version AdoptTerms rejects | Owner authorizes funding at request |
